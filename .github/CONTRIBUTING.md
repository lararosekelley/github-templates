...
1. Any changes to the install script, template files, or README.md must pass the `bats test.bats` command.
   It checks your code using the `mdl` and `shellcheck` tools to ensure consistency and conformity to best practices.
    - Install `mdl` using Ruby gems: `gem install mdl`
    - Install `shellcheck` by following instructions for your OS [here](https://github.com/koalaman/shellcheck#installing)

[1]: mailto:tylucaskelley@gmail.com
[2]: https://github.com/tylucaskelley/github-templates/issues/new
[3]: https://github.com/tylucaskelley/github-templates/compare
[4]: https://github.com/tylucaskelley/github-templates/pulls
